...
data = pd.read_excel('Fault_Model.xlsx', sheet_name='Sheet1')
grav = np.array(np.genfromtxt('fault model.dat'))
...
plt.subplot(2,1,2)
a = plt.imshow(VV,  extent = [0, 9, 6, 0], aspect = 'auto')
